    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full bg-zinc-900 border border-zinc-800 rounded-lg pl-12 pr-4 py-3 text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors"
        />
      </div>
