...
export const mockTheorems: Theorem[] = [
	{
		...
		computation: {
			...
			resultLatex: (r) => `E = ${r.toExponential(4)} \\; \\text{J}`,
		},
	},
	{
		id: "thm-002",
		...
		computation: {
			...
			targetUnit: "N",
			compute: (v) => v.m * v.a,
			resultLatex: (r) => `F = ${r.toPrecision(6)} \\; \\text{N}`,
		},
	},
	{
		id: "thm-003",
	...
	},
	{
		...
		variables: [
			{ name: "mass", symbol: "m", unit: "kg", defaultValue: 1 },
			{ name: "velocity", symbol: "v", unit: "m/s", defaultValue: 10 },
		],
		computation: {
			...
			resultLatex: (r) => `E_k = ${r.toPrecision(6)} \\; \\text{J}`,
		},
	},
	{
		id: "thm-006",
		...
		operator: "Crossover",
		variables: [
			{ name: "momentum", symbol: "p", unit: "kg·m/s", defaultValue: 0 },
			{ name: "mass", symbol: "m", unit: "kg", defaultValue: 1 },
			{
				name: "speed of light",
				symbol: "c",
		...
		computation: {
			...
			targetSymbol: "E",
			targetUnit: "J",
			compute: (v) => Math.sqrt((v.p * v.c) ** 2 + (v.m * v.c * v.c) ** 2),
			resultLatex: (r) => `E = ${r.toExponential(4)} \\; \\text{J}`,
		},
	},
	{
	...
	},
	{
		...
		operator: "Mutation",
		variables: [
			{ name: "amount", symbol: "n", unit: "mol", defaultValue: 1 },
			{
				name: "gas constant",
				symbol: "R",
				unit: "J/(mol·K)",
			...
			{ name: "temperature", symbol: "T", unit: "K", defaultValue: 273.15 },
		],
		computation: {
			target: "pressure × volume",
			targetSymbol: "PV",
			targetUnit: "J",
			compute: (v) => v.n * v.R * v.T,
			resultLatex: (r) => `PV = ${r.toPrecision(6)} \\; \\text{J}`,
		},
	},
	{
		id: "thm-009",
