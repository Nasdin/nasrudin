...
theorem discover_gen1
    ...
    : (E ^ 2) = ((m * (c ^ 2)) ^ 2) := by
  first
    | (nlinarith [hE, hm, h_four_momentum_time_component, h_minkowski_invariant_def, h_rest_frame_psq_zero, h_invariant_mass_postulate, h_energy_nonneg, h_mass_nonneg])
    | (linarith [hE, hm, h_four_momentum_time_component, h_minkowski_invariant_def, h_rest_frame_psq_zero, h_invariant_mass_postulate, h_energy_nonneg, h_mass_nonneg])
    | (ring_nf at * <;> nlinarith [hE, hm, h_four_momentum_time_component, h_minkowski_invariant_def, h_rest_frame_psq_zero, h_invariant_mass_postulate, h_energy_nonneg, h_mass_nonneg])
