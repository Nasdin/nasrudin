...
theorem discover_gen3
    ...
    : (E ^ 2) = ((m * (c ^ 2)) ^ 2) := by
  first
    | (nlinarith [hE, hm, h_four_momentum_time_component, h_invariant_mass_postulate, h_invariant_mass_postulate, h_rest_frame_psq_zero, h_energy_nonneg, h_mass_nonneg])
    | (linarith [hE, hm, h_four_momentum_time_component, h_invariant_mass_postulate, h_invariant_mass_postulate, h_rest_frame_psq_zero, h_energy_nonneg, h_mass_nonneg])
    | (ring_nf at * <;> nlinarith [hE, hm, h_four_momentum_time_component, h_invariant_mass_postulate, h_invariant_mass_postulate, h_rest_frame_psq_zero, h_energy_nonneg, h_mass_nonneg])
